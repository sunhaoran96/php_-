            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-6">
                            <form action="/home/admin/update2/id/<?php echo ($types["id"]); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>图书分类编号</label>
                                    <input type="text" class="form-control" name="booktypeid" value="<?php echo ($types["booktypeid"]); ?>">
                                </div>
                                <div class="form-group">
                                    <label>图书分类名称</label>
                                    <input type="text" class="form-control" name="booktypename" value="<?php echo ($types["booktypename"]); ?>">
                                </div>
