...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/admin/dist/css/main.css"/>
    <script type="text/javascript" src="/Public/admin/dist/js/modernizr.min.js"></script>
    <script type="text/javascript" src="/Public/admin/dist/js/jquery-2.2.3.min.js"></script>
