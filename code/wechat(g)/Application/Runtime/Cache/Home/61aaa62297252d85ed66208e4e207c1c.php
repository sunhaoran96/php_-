    ...
    <ul class="sys-info-list">
        ...
        <?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
            ...
            <ul style="margin-left:2em;">
                ...
                <input type="text" value="<?php echo ($sub_vo->name); ?>" name="name"/>
                    <span>
                <?php $type=$sub_vo->type; ?>
                <?php if($type=='click'): ?><input type="radio" value="click" name="type<?php echo ($ii); echo ($j); ?>" checked/> 点击
                <input type="radio" value="view" name="type<?php echo ($ii); echo ($j); ?>" /> 链接
                <?php else: ?>
                    <input type="radio" value="click" name="type<?php echo ($ii); echo ($j); ?>" />点击
                    <input type="radio" value="view" name="type<?php echo ($ii); echo ($j); ?>" checked="checked" /> 链接<?php endif; ?>
            </span>
