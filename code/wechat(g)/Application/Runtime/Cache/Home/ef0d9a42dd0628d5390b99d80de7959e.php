            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-6">
                            <form action="/home/admin/update/id/<?php echo ($books["bookid"]); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>图书编号</label>
                                    <input type="text" class="form-control" name="bookid" value="<?php echo ($books["bookid"]); ?>">
                                </div>
                                <div class="form-group">
                                    <label>图书名称</label>
                                    <input type="text" class="form-control" name="bookname" value="<?php echo ($books["bookname"]); ?>">
                                </div>

                                <div class="form-group">
                                    <label>图书分类</label>

                                    <select class="form-control" name="booktypename">
                                        <?php if(is_array($btype)): $i = 0; $__LIST__ = $btype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option name="booktypename" value="<?php echo ($vo['booktypename']); ?>"><?php echo ($vo['booktypename']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>

                                </div>
                                <div class="form-group">
                                    <label>图书价格</label>
                                    <input type="text" class="form-control" name="bookprice" value="<?php echo ($books["bookprice"]); ?>">
                                </div>
                                <div class="form-group">
                                    <label>图书剩余量</label>
                                    <input type="text" class="form-control" name="bookstoremount" value="<?php echo ($books["bookstoremount"]); ?>">
                                </div>
...
<script>
$("select").val(<?php echo ($vo->booktypename); ?>);
</script>
